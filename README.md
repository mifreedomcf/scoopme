...
This repository covers **Milestone 1 (closed adult pilot foundation)** and
**Milestone 2 (driver operations and safety)**. Ride fulfilment is switched off
...
base44/
  ...
  functions/<name>/entry.ts 28 Deno serverless functions
  functions/*/function.jsonc  3 scheduled automations
src/                        React + Vite frontend, 18 screens
tests/                      146 Vitest tests over the decision logic and schemas
```
...
Milestones 3–7: organization scheduling UI and partner-scoped reports, the
guardian/minor workflow (architected, flag-disabled), maps and consented live
tracking, donations and the tip ledger, and production hardening.
