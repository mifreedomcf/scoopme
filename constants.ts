...
export const SAFE_DEFAULT_CONFIG = {
  ...
  routing_provider_mode: "straight_line_estimate",
  relay_provider_mode: "none",
  retention_sweep_enabled: false,
  retention_overrides: {} as Record<string, number>,
  ...
  // Minor transport. Every one of these starts at the restrictive value, and
  // the two review flags start false, so a minor ride cannot be approved until
  // a person has actually checked the rules against the statute.
  standing_minor_consent_approved: false,
  restraint_policy_reviewed: false,
  restraint_jurisdiction: "MI",
  restraint_rear_facing_max_age: 2,
  restraint_forward_facing_max_age: 5,
  restraint_booster_max_age: 8,
  restraint_booster_height_exemption_inches: 57,
  restraint_rear_seat_required_under_age: 13,
  restraint_seat_belt_required_under_age: 16,
